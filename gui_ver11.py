...
class LIVE_PLOT_APP(QtWidgets.QMainWindow):
    ...
    def define_HY2(self, name):  # Hydrophone #2
    ...
    #     self.VB1 = gui_support.NI(name="VB1", device='Dev2', fs=40000, chunk=4000, displayL=40000, channel='ai0')
    #     self.VB1_plot = gui_support.plotting(self.VB1, self.VB1_canvas, self.VB1_canvasf, 10)

    def define_VB1(self, channel):  # AE Sensor #1
        self.VB1 = gui_support.NI(name="AE1", device='MyDAQ1', fs=200000, chunk=40000, displayL=400000, channel='ai0')
        self.VB1_plot = gui_support.plotting(self.VB1, self.VB1_canvas, self.VB1_canvasf, 10)
    ...
    def restrain_buttons_forSetUp(self):
        ...
        sensors_gui = [self.ALL_guiRelated, self.HY1_guiRelated, self.VB1_guiRelated]
        restrained_forSetUp = []
